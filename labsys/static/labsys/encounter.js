(function () {
  ...
  document
    .querySelector("#addpaymentbutton")
  ...
  document
    .getElementById("addpaymentinput")
  ...
  document.querySelectorAll(".deletetest").forEach(function (element) {
    element.addEventListener("click", function (event) {
      ...
      if (
        confirm(
          "Are you sure you want to delete " + test + "  form this Patient?"
        )
      ) {
